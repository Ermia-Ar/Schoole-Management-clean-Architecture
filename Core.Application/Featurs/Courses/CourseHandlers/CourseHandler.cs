...
namespace Core.Application.Featurs.Courses.CourseHandlers
{
    public class CourseHandler : ResponseHandler
        ...
        ,IRequestHandler<GetCourseListQuery, Response<List<CourseResponse>>>
        ...
        ,IRequestHandler<GetCourseByIdQuery , Response<CourseResponse>>
    {
        ...
        public async Task<Response<List<CourseResponse>>> Handle(GetCourseListQuery request, CancellationToken cancellationToken)
        {
